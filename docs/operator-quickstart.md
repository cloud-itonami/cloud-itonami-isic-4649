# Operator Quickstart — Wholesale of other household goods

Shortest path from clone to a verified local dry-run for **ISIC 4649** (`cloud-itonami-isic-4649`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4649.git
cd cloud-itonami-isic-4649
```
...
- Blueprint governor key: `consumer-product-safety-governor`
- Likely source path: `housewaretrade.governor.cljc`
