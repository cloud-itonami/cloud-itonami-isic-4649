...
(deftest delivery-dispatch-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real household-goods dispatch"
...
(deftest invoice-settle-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real household-goods invoice settlement"
    (doseq [[n {:keys [auto]}] phase/phases]
